...
const Header = () => {
    ...
    return (
        <div className="header absolute w-full z-50 text-dark md:text-white">
            <header className="">
                <nav className="container flex border-bottom-2  items-center justify-between p-2 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <a href="#" className="-m-1.5 p-1.5">
                            <span className="sr-only">Your Company</span>
                            <img className="h-6 w-auto max-w-[196px]" src="/images/logo.svg" alt="" />
                    ...
                    <div className="hidden lg:flex lg:gap-x-12">
                        <div className="relative">
                            ...
                            >
                                Product
                                <FaAngleRight  className="text-yellow" />
                            </button>
                        ...
                        <a href="#" className="text-sm/6 font-normal  ">Features<FaAngleRight  className="text-yellow inline" />                        </a>
                        <a href="#" className="text-sm/6 font-normal  ">Marketplace<FaAngleRight className="text-yellow inline"/></a>
                        <a href="#" className="text-sm/6 font-normald  ">Company<FaAngleRight className="text-yellow inline" /></a>
                    </div>
                ...
                <div className={`lg:hidden ${isMenuOpen ? "block" : "hidden"}`} role="dialog" aria-modal="true">
                    ...
                    <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                        <div className="flex items-center justify-between">
                            <a href="#" className="-m-1.5 p-1.5">
                                <span className="sr-only">Your Company</span>
                                <img className="h-6 w-auto max-w-[196px]" src="/images/logoDark.svg" alt="" />
                                {/* <h4>Logo</h4> */}
                            </a>
